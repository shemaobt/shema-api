"""BE-01's mount, asserted through the mechanism that will carry BE-03's first route.
...
The prefix is ``docs/shema.md`` §2.1's, and this test is the one place outside
``app/main.py`` that spells it.
"""

from __future__ import annotations

from app.api.shema import router
