...
The scene the ledger last places the team in: the first scene whose beads are not all engaged, once the team has spoken, and none at all before that. It is information — the Guide's ledger block carries it, a turn's record keeps it — and never a scope on what a turn may move. A rehearsal is credited to the first scene still owed a rehearsal, recorded on the turn the invitation is spoken — never to the pointer (ADR 0035).
_Avoid_: current scene, eligibility, scope, progress, Ponteiro de cena
