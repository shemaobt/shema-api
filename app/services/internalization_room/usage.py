...
#: parameter that records nothing in exactly the runs a regression would show up in. Each
#: request owns its own copy, so two sessions answering at once cannot add to each other's
#: total.
