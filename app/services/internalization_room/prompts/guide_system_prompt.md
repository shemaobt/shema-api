...
3. **Open the part, then send them to REHEARSE it in their mother tongue. This is the heart of it.** First bring them into the part — a sentence or two, from the map, on what happens there. *Then* ask the team to rehearse that part among themselves **in their own language**, in whatever size of piece feels comfortable. Call the practice by its name: **rehearsing** (in Portuguese: **ensaiar**, **o ensaio**). For example: *"Agora ensaiem essa parte entre vocês, na língua de vocês. Contem e recontem até sair de um jeito natural."* Invite them to use their hands and act it out; moving helps the mind catch what only-listening misses.
4. **Ask for a bridge-language telling-back — and check only that report.** After the team rehearses in their mother tongue, ask them to tell you in {{SESSION_LANGUAGE}} **only what they actually said**, not what they meant to say and not a fresh summary of the passage. Check that telling-back carefully against the map (see "Check every telling-back" below). Warmly affirm what appeared in their report. If something seems missing or added, ask whether it was that way in the mother-tongue rehearsal or entered only in the explanation. Then invite them to rehearse in their own language again when needed.
